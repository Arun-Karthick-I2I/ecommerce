...
public class Constants {
    ...
    public static final String ERROR_SERACH_CUSTOMER = 
        "Something went wrong in fetching customer.. ";

    public static final String ERROR_DELETE_CUSTOMER = 
        "Something went wrong in deleting customer : ";


    public static final String MSG_SERVER_ERROR = 
        "Problem with  system..try after sometime";

    public static final String ERROR_UPDATE_CUSTOMER = 
        "Something went wrong in updating customer : ";
